...
import logging
import os
from agenticrag.backend.app.ingestion.new.table_html_parser import parse_complex_html_table  # <<< CHANGED: fixed import, points to real module now
...
if __name__ == "__main__":
    ...
    try:
        # single file
        docs = pipeline.process([Path("sample_complex_3page.pdf")])

        # batch
        # docs = pipeline.process([Path("doc1.pdf"), Path("doc2.pdf"), Path("doc3.pdf")])
